...
{
    public partial class ObuvnajaFabricaEntities : DbContext
    {
        public ObuvnajaFabricaEntities()
            : base("name=ObuvnajaFabricaEntities")
        {
        }
        ...
        {
            modelBuilder.Entity<Authorizacia>()
                .HasMany(e => e.Sotrudniki)
                .WithRequired(e => e.Authorizacia)
                .HasForeignKey(e => e.KodParolia)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<Brigadi>()
                .HasMany(e => e.Sotrudniki)
                .WithOptional(e => e.Brigadi)
